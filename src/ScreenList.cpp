...
namespace GangerEngine {
    ...
    IGameScreen* GangerEngine::ScreenList::MoveNext() {
    ...
    IGameScreen* GangerEngine::ScreenList::MovePrevious() {
        IGameScreen* currentScreen = GetCurrent();
    ...
    void GangerEngine::ScreenList::SetScreen(int nextScreen) {
    ...
    void GangerEngine::ScreenList::Destroy() {
