...
void Ball::Init(float radius, float mass, const glm::vec2& pos,
    ...
    GangerEngine::ResourceManager::GetTexture(
        "Assets/Pong/Sprites/Pong.png");
    m_color = GangerEngine::ColorRGBA8(255, 255, 255, 255);
...
void Ball::Draw(GangerEngine::SpriteBatch& spriteBatch) {
...
void Ball::DrawDebug(GangerEngine::DebugRenderer& debugRenderer) {
    GangerEngine::ColorRGBA8 color(255, 0, 255, 255);
    // Draw box
    debugRenderer.DrawCircle(m_position, color, m_radius);
}
