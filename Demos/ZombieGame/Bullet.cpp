...
void Bullet::draw(GangerEngine::SpriteBatch& spriteBatch) {
    ...
    spriteBatch.Draw(destRect, uvRect, GangerEngine::ResourceManager::GetTexture("Textures/circle.png").id, 0.0f, color);
}
